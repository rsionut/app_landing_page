...
export default function Testimonial () {
    ...
    return (
        <div className='bg-background p-8 md:p-16'>
            ...
            <p className='text-center text-[24px] md:text-[28px] 2xl:text-[32px]'>Compete with friends in Mini Leagues and connect with other cycling enthusiasts</p>
            <div className='pt-12'>
                ...
                <div className='w-full flex flex-wrap justify-around pt-12 gap-8'>
                    {
                        [1, 2, 3].map(index => (
                            <div key={`testimonial_${index}`} className='w-full md:w-[400px] drop-shadow-[0_24px_24px_rgba(89, 89, 89, 0.25)] flex flex-col justify-center text-center border border-[#bababa] rounded-xl p-8'>
