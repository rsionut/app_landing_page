...
const HeroSection = () => {
    ...
    return (
        <div className="h-screen w-full flex flex-col md:flex-row md:justify-between items-center bg-hero-background bg-cover bg-center pt-24 px-8 md:px-16">
            <div className='w-full md:w-1/2 order-2 md:order-1 md:pt-16 text-white font-[Manrope]'>
            ...
            <div className='w-full md:w-1/2 order-1 md:order-2 flex justify-center items-center'>
                <CustomImage src={'/images/hero_phone.png'} alt='hero' className='w-[150px] sm:w-[200px] md:w-[300px]' />
            </div>
        </div>
    )
}
